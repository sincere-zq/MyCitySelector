package yanyu.com.mycity.wheel;
...
import yanyu.com.mycity.wheel.adapter.DateWheelAdapter;
...
public class DateWheelPicker extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        yearWheelAdapter = new DateWheelAdapter(context, 1900, 9999, "");
        years.setViewAdapter(yearWheelAdapter);

        monthWheelAdapter = new DateWheelAdapter(context, 1, 12, "");
        ...
        dayWheelAdapter = new DateWheelAdapter(context, 1, maxday_of_month, "");
